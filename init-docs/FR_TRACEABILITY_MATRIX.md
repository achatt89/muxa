...
| FR-6 | Client-specific mapping layer (reusable) | E5-T2 | `toolingSystem.clientToolMapping`, `integrationClientFlows.codex/cursor/claude` | `test/client-mapping/*.test.js`, `test/integration/codex-flow.test.js`, `test/integration/cursor-flow.test.js`, `test/integration/claude-cli-flow.test.js` |
...
| FR-13 | Installation/runtime modes | E1-T1, E9-T1 | `installationProfiles`, `deploymentProfiles`, `integrationClientFlows` | `test/bootstrap/cli-start.test.js`, `test/integration/*.test.js` |
...
| FR-23 | Auxiliary compatibility endpoints | E2-T4, E9-T1 | `clientCompatibility.auxiliaryEndpoints`, `apiContract.opsEndpoints` | `test/api/event-logging-noop.test.js`, `test/integration/*.test.js` |
